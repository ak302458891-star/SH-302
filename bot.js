...
const checkUserJoinedChannels = async (userId) => {
  const channels = ['@Hamza302Official', '@Hamza302Official'];
  let allJoined = true;
    ...
    `🚨 *You must join our official channels before pairing.*`,
    {
      ...
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: '📢 Channel 2', url: 'https://t.me/+aDpvyF-WszZjNGM0' }],
          [{ text: '👥 Group', url: 'https://t.me/+kNmaJOJoxtEwYjRk' }],
...
(async () => {
  ...
  console.log('✅ Bot Username: @Hamza302bot');
