/**
   * Create By HAMZA-302 OFFICIAL
   * Contact Me on 923470807458
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   HAMZA-458 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting HAMZA-302 system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅HAMZA-302 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('HAMZA-302 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅HAMZA-302 тɛℓɛɢяαм вσт: Active') : chalk.red('❌HAMZA981 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ HAMZA-302 system is ready and running!\n'));
    }
